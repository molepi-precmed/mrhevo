...
data {
  ...
  real < lower=0 > tau; // fixed global shrinkage parameter
...
transformed parameters {
  ...
  vector[J] gamma; // effect of each instrument Z on Y, distributed as N(gamma_hat, sd.gamma_hat)
...
model {
  ...
  // half Student-t priors for local scale parameters (nu = 1 corresponds to horseshoe)
