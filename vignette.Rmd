...
For now the method requires an individual-level dataset with genotypes and outcome, though it uses summary statistics for the genotype-exposure associations.  
...
p.coeffs <- ggplot(coeffs.scores,
    ...
    ggrepel::geom_text_repel(aes(label=qtlname), force=2, size=2.5, fontface="italic", color="blue") + 
...
hevo.stanfit <- run_mrhevo.sstats(N, alpha_hat, se.alpha_hat,
